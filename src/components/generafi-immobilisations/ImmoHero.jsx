...
import immobanner from "../../../public/assets/imgs/hero/3/immobanner.jpg";
...
const ImmoHero = () => {
  ...
  return (
    <>
      <section className="hero__area-3 hero__immo" ref={heroArea}>
            ...
            <div className="col-xxl-12">
              <div className="hero__inner-3">
                ...
                <div className="hero__text-3">
                  ...
                  Etes-vous certain que vous maitrisez votre parc d’immobilisation ?
